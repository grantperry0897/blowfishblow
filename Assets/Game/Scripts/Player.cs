...
public class Player : MonoBehaviour
{
    ...
    [SerializeField] private ParticleSystem pearlReward;
    [Header("Expansion")]
    ...
    [SerializeField] private AudioSource fastFallLoop;
    [SerializeField] private AudioClip jumpSound;
    [SerializeField] private AudioClip bounceSound;
    [SerializeField] private AudioClip pearlCollectSound;
    ...
    void Update()
    {
        ...
        {
            if(!bubbleTrail.isPlaying) bubbleTrail.Play();
            if(!fastFallLoop.isPlaying) fastFallLoop.Play();
        }
        else
        {
            bubbleTrail.Stop();
    ...
    void OnTriggerEnter2D(Collider2D collider)
    {
        ...
        if (collider.tag == "Pearl")
        {
            ...
            pearlCount += 1;
            audioSource.PlayOneShot(pearlCollectSound);
            pearlReward.Play();
        }
    }
